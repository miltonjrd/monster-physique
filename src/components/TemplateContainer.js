    ...
    <Container id="template-container">
      <div>
        <div className="position-relative text-center" style={{ flex: 1 }}>
          ...
          <embed 
            ...
            src={`${baseUrl}/svgs/aaa.svg`} 
            type="image/svg+xml" 
          />
          <img className='template-img' src={`${baseUrl}/mockups/${simulatorContext.template?.mockup_front}`} alt="" tabIndex={-1} />
          <div
            className="position-absolute top-0 w-100 h-100"
            style={{
              WebkitMaskImage: `url(${baseUrl}/mockups/${simulatorContext.template?.mockup_front})`,
              WebkitMaskSize: '100%'
            }}
          >
            {
      ...
      <div>
        <div className="position-relative text-center" style={{ flex: 1 }}>
          ...
          <img className='template-img' src={`${baseUrl}/mockups/${simulatorContext.template?.mockup_back}`} alt="" tabIndex={-1} />
          <div
            className="position-absolute top-0 w-100 h-100"
            style={{
              WebkitMaskImage: `url(${baseUrl}/mockups/${simulatorContext.template?.mockup_back})`,
              WebkitMaskSize: '100%'
            }}
          >
            {
